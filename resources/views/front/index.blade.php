        ...
        <div id="category-filter">
            <ul class="category-list">
                ...
                {{-- <li class="category-item kids-teens">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-02.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                ...
                <li class="category-item video">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-03.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item audio">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-04.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item books">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-05.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item magazines">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-06.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item adults">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-07.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
                ...
                <li class="category-item kids-teens">
                    <figure>
                        <img src="{{ asset('front_assets/images/category-filter/home-v1/category-filter-img-08.jpg') }}"
                            alt="New Releaase" />
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4>The Great Gatsby</h4>
